# Отчет по тестированию запроса /user/search?first_name=И&second_name=Брагина без индексов и с индексами. Сервис srv/sn
Используем k6. Скрпиты находятся в https://github.com/avp365/hl-sn/tree/main/.infra/srv/k6/scripts
Генерация https://github.com/avp365/hl-sn/blob/main/srv/sn/tools/generator/users/main.go , в 10 csv файлов, который загружаются с помощью .infra/srv/psql/docker-compose.yml   pgadmin
