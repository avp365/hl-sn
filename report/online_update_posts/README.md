...
[/home/dev/go/src/github.com/avp365/hl-sn/tools/generator/posts/main.go](https://github.com/avp365/hl-sn/blob/cache_queue/srv/sn/tools/generator/posts/main.go)

Миграция для таблицы:
https://github.com/avp365/hl-sn/blob/cache_queue/srv/sn/internal/migrations/20240629232858_table_friends.sql
https://github.com/avp365/hl-sn/blob/cache_queue/srv/sn/internal/migrations/20240630302858_table_posts.sql
...
В данном случае у нас есть два механизма сброса кеша. Время и очереди. В зависимости от нагрузки и наблюдениям за проектом можно будет их тюнить по тем или иным правилам. В данной работе представлен базовый механизм, один из многих.